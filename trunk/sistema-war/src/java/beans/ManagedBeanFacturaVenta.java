...
import be.DetalleFacturaVentaProductoPK;
   ...
   StringBuilder cadena_fecha_buscar = new StringBuilder( fecha_boleta.format( factura.getFechaVenta() ) );
        try
        {
           ...
           String producto_string ="";
                ...
                pw.println("-----------------------------" );
                pw.println("TOTAL SIN IGV  " +factura.getTotalVenta()+" N.SOLES.");
                pw.println("TOTAL + IGV  " +factura.getTotalVentaIncluidoIgv()+" N. SOLES."+"\n");
